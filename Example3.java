// Различия между целыми и дробными числами типы данных int и double.
class Example3 {
 public static void main (String args[]) {
  ...
  var = var/4;
  x = x/4;
  System.out.println ("Вывести значение переменной var после деления: " + var) ;
  System.out.println ("Вывести значение переменной x после делеления: " + x) ;
  }
}
